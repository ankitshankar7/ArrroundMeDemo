...
import com.example.arroundmedemo.restaurants.ui.fragments.NearByRestaurantFragment
import com.example.arroundmedemo.utils.setSafeOnClickListener
import okhttp3.internal.notify

class RestaurantListAdapter(val fragment: NearByRestaurantFragment) :
    RecyclerView.Adapter<RestaurantListAdapter.MatchRowViewHolder>() {
    ...
    class MatchRowViewHolder(private val itemBinding: ItemMapBinding, private val restaurantListener: RestaurantListener) :
